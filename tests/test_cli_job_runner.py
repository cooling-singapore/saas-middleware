...
# def test_cli_runner_success_with_address_mapping(temp_dir, node, deployed_test_processor):
#     # prepare the job folder
#     job_id = '398h36g3'
#     job_path = prepare_full_job_folder(temp_dir, node, node.identity, deployed_test_processor, job_id, a=1, b=1)
#
#     # generate the mapping
#     mapping = generate_address_port_mapping(node.db.get_network())
#     assert '127.0.0.1:5100' in mapping
#     assert '127.0.0.1:4100' in mapping
#     assert mapping['127.0.0.1:5100'] == 7000
#     assert mapping['127.0.0.1:4100'] == 6000
#
#     # now tweak the mapping so it works with the test case node
#     mapping['127.0.0.1:5100'] = 5100
#     mapping['127.0.0.1:4100'] = 4100
#     mapping_path = os.path.join(job_path, 'address_mapping.json')
...
#
#
# def test_cli_runner_failure_with_address_mapping(temp_dir, node, deployed_test_processor):
...
#     assert mapping['127.0.0.1:4100'] == 6000
#
#     # now tweak the mapping so it works with the test case node but remove one to trigger exception
#     mapping['127.0.0.1:5100'] = 5100
#     mapping.pop('127.0.0.1:4100')
#     mapping_path = os.path.join(job_path, 'address_mapping.json')
#     with open(mapping_path, 'w') as f:
#         json.dump(mapping, f, indent=2)
#
...
#     assert 'UnresolvedInputDataObjectsError' in job_result.trace  # that's because the obj lookup will wail
