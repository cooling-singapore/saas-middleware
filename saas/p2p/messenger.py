...
class SecureMessenger:
    ...
    def send_request(self, content: dict, attachment_path: str = None) -> dict:
        """
    ...
    def send_response(self, request_id: str, content: dict, attachment_path: str = None) -> None:
        """
    ...
    def _handshake(self, identity: Identity) -> Identity:
        try:
            ...
            self._send_object(identity.serialise())
            self.peer = Identity.deserialise(self._receive_object())
